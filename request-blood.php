                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 hidden-sm hidden-xs"> 
                        ...
                        <figure class="appointment-img">
                            <img src="images/doc1.png" alt="appointment image">
                        </figure>
                    </div> 
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12"> 
                        ...
                        <div class="appointment-form-wrapper text-center clearfix">
                            <h3 class="join-heading">Request Blood</h3>
...
*/
  ...
  $sql = "INSERT INTO acceptor(fname,lname,phone,email,bloodgroup,city) VALUES('$fname','$lname','$phone','$email','$bloodgroup','$city')";
  
  if(mysqli_query($con,$sql))
 {
    
    echo "<font color='green'>Request Submitted.Thanks<font><br/>";
  ...
  ?>
                            ...
                            <form class="appoinment-form" name="registration"> 
                                <div class="form-group col-md-6">
                                    <input id="your_name" class="form-control" placeholder="First Name" type="text" name="fname">
                                </div>
                                <div class="form-group col-md-6">
                                    <input id="your_username" class="form-control" placeholder="Last Name" type="text" name="lname">
                                </div>
                                 <div class="form-group col-md-6">
                                ...
                                <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                    <button id="btn_submit" class="btn-submit" type="submit" name="submit">Submit</button>
                                </div>
